...
class IncomeScreen extends StatefulWidget {
  const IncomeScreen({Key? key, required this.action, required this.action2}) : super(key: key);
                    ...
                    child: Container(
                        ...
                        child: customButton(
                            ...
                            SnackBar(content: Text("Fill the details",style: TextStyle(color: Colors.white),),backgroundColor: redColor,):
                                ()async{
                                    final transaction = Transaction(title: category, category: category, transaction: moneyController.text, isExpense: false, subtitle: descriptionController.text, time: DateFormat('hh:mm a').format(DateTime.now()));
                                    await widget.action(transaction);
                                    BalanceController.income+= int.parse(moneyController.text);
